...
# TODO later do without these infos
# Specify your username and user ID
USER_NAME=zsidanyi   # find with `id -un` or `whoami`
...
internal="eDP1"         # change as needed
external="HDMI1"        # change as needed
device="card1-HDMI-A-1"  # change as needed
